...
# Extract numerical IDs from filenames for sorting
...
class LabelMixupDatasetK(Dataset):
...
SAVE_ROOT = "/home/hongyi/project/mixup/model/Ablation/TENX13/mixup_knn_label"
...
df.to_csv(os.path.join(LOSS_ROOT, "mixup_knn_label.csv"), index=False)
